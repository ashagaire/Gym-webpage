...
<header class="flex flex-col relative z-20">
    <div class="max-w-[1400px] mx-auto w-full flex items-center justify-between p-4 py-6">
        ...
        <button on:click={() => ($openModal= true)} class="md:hidden grid place-item-center" >
            <i class="fa-solid fa-bars"></i>
        </button>
        <nav class="hidden md:flex item-center gap-4 lg:gap-6">
            <a class="duration-200 hover:text-indigo-400 cursor-pointer" href="#product" > Products</a>
            <a class="duration-200 hover:text-indigo-400 cursor-pointer" href="#review">Reviews</a>
